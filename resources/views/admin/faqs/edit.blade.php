 ...
 <form action="{{ route('admin.faqs.update', ['id' => $faqs->id]) }}" method="POST" enctype="multipart/form-data" id="editForm">
     @csrf
     <div class="row gx-3">
                     ...
                     <div class="row gx-3">
                         <div class="col-lg-6 col-sm-4 col-12">
                             <div class="mb-3">
                                 ...
                                 <select class="form-select" name="country_id" id="country_id">
                                     <option value="0" {{ old('country_id', $faqs->country_id) == 0 ? 'selected' : '' }}>Select</option>
                                     @foreach($countries as $country)
                                     <option value="{{ $country->id }}" {{ old('country_id', $faqs->country_id) == $country->id ? 'selected' : '' }}>
                                         {{ $country->country }}
                                     </option>
                                     @endforeach
                                 </select>
                         ...
                         <div class="col-lg-6 col-sm-4 col-12">
                             <div class="mb-3">
                                 ...
                                 <textarea class="form-control" rows="3" name="question">{{ old('question', $faqs->question) }}</textarea>
                                 @error('question')
                         ...
                         <div class="col-sm-6 col-12">
                             <div class="mb-3">
                                 ...
                                 <textarea class="form-control" rows="3" name="answer">{{ old('answer', $faqs->answer) }}</textarea>
                                 @error('answer')
                                 <p class="fs-6 text-danger">{{ $message }}</p>
                                 @enderror
                             </div>
                             ...
                             <div class="mb-3">
                                 ...
                                 <div>
                                     <div class="form-check form-check-inline">
                                         <input class="form-check-input" type="radio" name="status" id="inlineRadio1" value="1" {{ old('status', $faqs->status) == '1' ? 'checked' : '' }}>
                                         <label class="form-check-label" for="inlineRadio1">Active</label>
                                     </div>
                                     <div class="form-check form-check-inline">
                                         <input class="form-check-input" type="radio" name="status" id="inlineRadio3" value="0" {{ old('status', $faqs->status) == '0' ? 'checked' : '' }}>
