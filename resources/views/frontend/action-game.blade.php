        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-md-start justify-content-center  g-6">
                        ...
                        <div class="tournament-img mb-8 position-relative">
                            ...
                            <a href="{{route('frontend.game_detail_page',  ['slug' => $game->slug])}}">
                                <img class="img-fluid" src="{{asset('storage/'.$game->image)}}"
                                    alt="tournament" alt="{{ $game->keyword }}"></a>
                            </div>
                            <!-- <span
                ...
                <div class="pagination">
                    {{ $actionGames->links('pagination::bootstrap-5') }}
                </div>
            </div>
            @else
            <div>
            ...
            @endif
            <div class="col-md-12 d-flex justify-content-end mb-10">
            <a href="{{ route('frontend.homepage.index') }}" class="btn-half-border position-relative d-inline-block py-2 bgp-1 px-6 rounded-pill bg-orange">Back to Home page</a>
