<style>
    .pagination-dark {
        ...
        padding: 0.5rem; /* Optional: space around pagination */
    ...
    .pagination-dark .page-link {
        ...
        border-radius: 0; /* Optional: remove border-radius for square edges */
    }

    .pagination-dark .page-item.active .page-link {
        background-color: #333; /* Slightly lighter background for active page */
        color: #fff; /* White text */
    ...
    .pagination-dark .page-item.disabled .page-link {
        color: #666; /* Gray color for disabled state */
        background-color: #000; /* Black background for disabled state */
        border-color: #444; /* Darker border for disabled state */
    }
</style>
                    ...
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="page-item active" aria-current="page">
                                <span class="page-link btn btn-primary">{{ $page }}</span>
                            </li>
                        @else
                            <li class="page-item">
                                <a class="page-link btn btn-outline-primary" href="{{ $url }}">{{ $page }}</a>
                            </li>
                        @endif
                    @endforeach
                @endif
